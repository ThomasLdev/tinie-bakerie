 ...
 */
#[ORM\Entity]
class CategoryMedia implements Translatable, MediaAttachment, Positionable, \Stringable
{
    ...
    public function removeTranslation(CategoryMediaTranslation $translation): self
    {
