...
final class PostCacheOptimizationTest extends KernelTestCase
{
    ...
    public function testColdCacheOptimizationReducesQueriesToOne(): void
    {
        ...
        self::assertNotNull($postBySlug, 'Post should be found');
        self::assertSame('article-test-1-fr', $postBySlug->getSlug());
    ...
    /**
     * Filter and return only SELECT queries from post tables.
     *
